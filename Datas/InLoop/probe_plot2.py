...
#After second presentation has been commented for removing the normalization
...
x_laser_amp_ac = x_laser_amp_avg-np.mean(x_laser_amp_avg)
x_laser_phs_ac = x_laser_phs_avg-np.mean(x_laser_phs_avg)
